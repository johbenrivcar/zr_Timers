...
* Timers may fire **Tick events** at a regular intervals >= 1 second.
* Timer **Expiry** is set as one of these:
  * a period of time from when .Start is called (i.e. lifeTime) or
  * a fixed point in time, regardless of when .Start is called (i.e. expiresAt)
